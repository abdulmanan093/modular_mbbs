      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <div className="h-10 w-10 rounded-lg border-2 border-primary/30 shadow-md bg-background flex items-center justify-center p-1">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm opacity-70">
            <li className="flex items-center gap-2"><Mail className="h-4 w-4" /> abdul10761093174@gmail.com</li>
            <li className="flex items-center gap-2"><Phone className="h-4 w-4" /> +923106078374</li>
          </ul>
        </div>
      </div>
